...
| [`concepts/deliveryproof`](concepts/deliveryproof/) | Receipts for delivered work: objective delivery checks produce signed release/refund evidence for rail-neutral settlement | **Concept — working prototype** | The *did-it-happen* half of the house thesis; complements COG's *what-is-it-worth* half with a core library, rail adapters, and nested demo app |
