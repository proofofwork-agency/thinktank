...
| [`concepts/deliveryproof`](concepts/deliveryproof/) | Receipts for delivered work: objective delivery checks produce signed release/refund evidence for rail-neutral settlement | **Concept — working prototype** (v0.10, 310 tests green) | The *did-it-happen* half of the house thesis; complements COG's *what-is-it-worth* half. Core invariant (no capture on a failing verdict) survived two adversarial agent passes; those passes found 7 exploitable defects at the *boundaries* — unauthenticated receipts, signed-but-unchecked assurance claims, and a mutable contract handed to seller code — all closed in v0.10 with PoC-derived regressions. Verdict: [`concept/VERDICT.md`](concepts/deliveryproof/concept/VERDICT.md) |
